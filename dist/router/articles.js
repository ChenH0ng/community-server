                    ...
                    case 3:
                        ...
                        _context.t3 = function (docs) {
                            return docs.map(function (doc) {
                                return new _models.Article(doc);
                            });
                        };
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _context3.next = 3;
                        return articles.create(new _models.Article(req.body));
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        _context4.next = 3;
                        return articles.update(req.params.id, req.body);
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        ...
                        _context5.next = 3;
                        return articles.remove(req.params.id);
