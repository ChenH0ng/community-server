...
var comments = new _db.Collection('comments');
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 3;
                        return comments.getAll({ inArticle: req.query.inArticle }, (0, _extends3.default)({}, req.query, {
                            sort: { createdAt: 1 }
                        }));
                    ...
                    case 3:
                        ...
                        _context.t3 = function (docs) {
                            return docs.map(function (doc) {
                                return new _models.Comment(doc);
                            });
                        };
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.next = 3;
                        return comments.get(req.params.id);
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _context3.next = 3;
                        return comments.create(new _models.Comment(req.body));
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        _context4.next = 3;
                        return comments.update(req.params.id, req.body);
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        ...
                        _context5.next = 3;
                        return comments.remove(req.params.id);
